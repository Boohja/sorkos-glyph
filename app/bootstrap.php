...
$f3->route('POST /sprites/@id/delete', 'App\Controllers\SpriteController->delete');
...
$f3->route('POST /api/sprites/@id/icons', 'App\Controllers\ApiController->addIcons');
$f3->route('POST /api/sprites/@id/icons/update', 'App\Controllers\ApiController->updateIcons');
...
$f3->route('GET /api/sprites/@id.svg', 'App\Controllers\ApiController->downloadSavedSprite');
